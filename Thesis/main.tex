...
After splitting the data and deciding on the evaluation method, the training set is used to fine-tune the LLM or train a new model on the LLM encodings. 
