...
After the optimal hyper-parameters are determined, the model is retrained using the full training data, including any data that was set aside for validation. This can also be done using nested cross-validation, where final model is trained at the same time as tuning the hyper-parameters.
