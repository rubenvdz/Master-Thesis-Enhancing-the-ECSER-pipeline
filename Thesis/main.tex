...
\begin{enumerate}
\item We increase the replicability of the research by using an open-source LLM as well as providing all our code and the processed data set on our GitHub page\footnote{\url{https://github.com/rubenvdz/Master-Thesis-Enhancing-the-ECSER-pipeline}}.
...
1. \textit{Define the goal of the prompt}: 

2. \textit{Choose the right prompt engineering approach}: 

3. \textit{Design the prompt}: 

4. \textit{Provide context}: 

5. \textit{Test and refine}: 

%TODO S4a. Hyper parameters-tuning. 
