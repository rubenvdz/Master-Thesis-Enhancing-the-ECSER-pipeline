...
\begin{table}[H]
	...
	\begin{tabular}{|l|c|c|c|c|c|c|c|c|}
		...
		Question Refinement (Llama) & 0.508 & 0.620 & 0.400 & 0.510 & 0.559 & 0.594 & 0.021 & 0.458 \\
		Question Refinement (GPT) & 0.466 & 0.540 & 0.380 & 0.460 & 0.500 & 0.523 & -0.081 & 0.511 \\
		\hline
	\end{tabular}
\end{table}

%TODO S5. Test the models.
\textbf{S5. Test the models.}\\

\subsubsection{Results Analysis}
%TODO S6. Report the Confusion Matrix.
\textbf{S6. Report the Confusion Matrix.}\\

%TODO S7. Report Metrics.
\textbf{S7. Report Metrics.}\\
