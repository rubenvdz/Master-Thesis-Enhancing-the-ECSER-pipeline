...
RQ1 follows the step of \textit{problem investigation} and is both descriptive and evaluative: what do researchers report in their studies and does this level of reporting contribute or detract from the accuracy and reproducibility of the results. The aim of this question is to provide insights into the potential shortcomings of existing research, in order to provide a basis for additional guidelines that help researchers avoid these shortcomings. %To answer the question, we conducted a mapping study of SE papers published in 2024 that use LLM classifiers using the guidelines by \citeauthor{kitchenham2011} \cite{kitchenham2011,kitchenham2007} and \textcite{petersen2008map}.
...
Following the problem investigation of RQ1, RQ2 fulfils the step of \textit{treatment design}. The purpose of RQ2 is to design a tangible artifact that is widely applicable to the field and comprehensive, taking into consideration recommendations from the fields of LLM4SE, ML4SE and Design Science (see Section \ref{Research approach}), with the intent to help researchers prevent common problems identified in RQ1.
